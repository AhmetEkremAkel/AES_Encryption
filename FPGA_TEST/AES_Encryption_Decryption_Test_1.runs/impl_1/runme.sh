...
HD_PWD='D:/Vivado documents/AES_CTR_Encryption_Decryption/FPGA_TEST/AES_Encryption_Decryption_Test_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_test_module_verilog.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_test_module_verilog.tcl -notrace
