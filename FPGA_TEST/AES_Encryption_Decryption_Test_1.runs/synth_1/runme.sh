...
HD_PWD='D:/Vivado documents/AES_CTR_Encryption_Decryption/FPGA_TEST/AES_Encryption_Decryption_Test_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_test_module_verilog.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_test_module_verilog.tcl
